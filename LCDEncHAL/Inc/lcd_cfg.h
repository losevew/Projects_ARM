...
#define LCD_RS 						  10u	/* Pin number */

/* R/W - Selects read or write.
 * 0:	Write
 * 1:	Read */
#define LCD_RW_OUT					GPIOB->ODR	/* Output register */
#define LCD_RW						   1u	/* Pin number */
...
// SET MCU TIMINGS
//-------------------------------
#define MCU_FREQ_VALUE				48u		/* MHz. Minimal value = 1 MHz */
...
#define PROGRESS_BAR_LINE			2u	/* Select lcd line: 1, 2, 3, 4, ... */
