...
// Буфер для скролла по индикатору
...
int main()
{
  ...
  // Мигнём всеми матрицами (типа тест индикаторов)
  ...
  while (1)
  {
    // Формируем буфер для скролла на матрице с желаемым текстом
    // Для форматированного вывода можно также использовать функцию font_printf
    uint16_t ScrollLines = font_DrawString("Привет мир", ScrollBuff, 140);
    // Скроллим текст по матрице справа налево
    demo_ScrollBuff(ScrollBuff, ScrollLines, 1);
		// Скроллим текст по матрице слева направо
